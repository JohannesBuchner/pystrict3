class NamedTupleMetaclass(type):
    ...
    def __init__(cls, classname, bases, classdict):
        ...
        cls._nameindices = dict(list(zip(classdict['names'], list(range(len(classdict['names']))))))
...
def NamedTuple(*namelist):
    ...
    class _NamedTuple(tuple, metaclass=NamedTupleMetaclass):
        names = list(namelist)
...
if __name__ == "__main__":
    class PersonTuple(tuple, metaclass=NamedTupleMetaclass):
