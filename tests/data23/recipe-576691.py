...
def LinuxDistros():
  req = urllib.request.Request("http://lwn.net/Distributions/")
...
def DistroRank(nix):
  enc = "http://search.yahoo.com/search?p="+urllib.parse.quote('"'+nix+'" "linux distribution"')
  req = urllib.request.Request(enc)
