    ...
    while line and (v is None or currver < v):
        ...
        while line and line.startswith(('.I', '.C')):
            if line.startswith('.I'):
                ...
                m, n = list(map(int, cline(line).groups()))
...
def main(argv):
    ...
    if command in 'le':
        ...
        print(make_header(filename, msg, create), file=repo_file)
        print(d, end=' ', file=repo_file)
        repo_file.close()
