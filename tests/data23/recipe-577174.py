...
class SimpleCrypt:
    ...
    def ReInit(self, ARGS):
        ...
        self.key         = (self.key,self.MSha(ARGS.get('Key')))['Key' in ARGS]
        self.cycles      = (self.cycles,ARGS.get('Cycles'))['Cycles' in ARGS]
        self.block_sz    = (self.block_sz,ARGS.get('BlockSz'))['BlockSz' in ARGS]
        self.key_advance = (self.key_advance,ARGS.get('KeyAdv'))['KeyAdv' in ARGS]
