...
import __future__
PyCF_MASK = sum(v for k, v in list(vars(__future__).items()) if k.startswith('CO_FUTURE'))
...
def test_roundtrip():
    ...
    for func in allfuncs:
        ...
        print('\r%d successful roundtrip, %d failed roundtrip, %d unsupported, %d nosource ' % (success, failed, unsupported, errors), end=' ')
