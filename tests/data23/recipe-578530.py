import urllib.request, urllib.error, urllib.parse, urllib.request, urllib.parse, urllib.error, urllister
import time
...
while True:
    ...
    raw_i=input("Song Name and Artist: ")
    x = urllib.parse.quote_plus(raw_i)

    site1 = urllib.request.urlopen('http://www.youtube.com/results?search_query=%s'%x)
    y = site1.read()
