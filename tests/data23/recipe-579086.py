...
class EMI_CALCULATOR(object):
     ...
     #get the  value of loan amount
          self.Loan_amount = eval(input("Enter The Loan amount(in rupees) :"))
          pass

      def get_interest_rate(self):
       # get the value of interest rate
          self.Interest_rate = eval(input("Enter The Interest rate(in percentage(%)) : "))
          pass

      def get_payment_period(self):
       # get the payment period"
          self.Payment_period = eval(input("Enter The Payment period (in month): "))
          pass
